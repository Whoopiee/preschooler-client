...
import styles from './DragFishInLakeLevel.module.scss';
...
const dragLakeImage = 'objects/dragLake.png';
...
export const DragFishInLakeLevel: React.FC = () => {
  ...
  return (
    <LevelLayout
      description="Засели озеро істотами, що можуть там проживати"
      audio="task/november/settle-lake.m4a"
      checkIsGameFinished={checkIsGameFinished}
      errorMessage="Засели усіх істот"
    >
      <DragDropContext
