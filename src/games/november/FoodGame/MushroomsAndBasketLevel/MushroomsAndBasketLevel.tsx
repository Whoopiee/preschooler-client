...
import styles from './MushroomsAndBasketLevel.module.scss';
...
const initialChoices: Choice[] = [
  ...
  {
    id: uuid(),
    image: 'plants/ryzyk.svg',
    row: 1,
    isRight: true,
  },
  {
    id: uuid(),
    image: 'plants/whiteMushroom.svg',
    row: 2,
    isRight: true,
  },
  {
    id: uuid(),
    image: 'plants/foxes.svg',
    row: 2,
    isRight: true,
  },
  {
    id: uuid(),
    image: 'plants/funeralBells.svg',
    row: 2,
    isRight: false,
  },
];
...
export const MushroomsAndBasketLevel: React.FC = () => {
  ...
  return (
    <LevelLayout
      description="Перетягни у корзину їстівні гриби"
      audio="task/november/drag-edible-mushrooms.m4a"
      checkIsGameFinished={checkIsGameFinished}
      errorMessage="Перетягни усі їстівні гриби"
    >
      <DragDropContext
